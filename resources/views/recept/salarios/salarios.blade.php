                ...
                <div class="table-responsive">
                    ...
                    <div id="tabla-puestos" class="card-body table-responsive p-0">
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                <tr v-for="salario in filtrarSalario">
                                    <td hidden=""></td>
                                    <td>@{{salario.id}}</td>
                                    <td> <span>@{{salario.valor}}</span> </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="valor" class=" form-control-label">Cantidad Salario</label>
                ...
                <div class="modal-body">
                    <label class="form-group">Puesto</label>
